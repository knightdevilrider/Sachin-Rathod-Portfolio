        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10 w-full h-full flex flex-col justify-start sm:justify-center pt-8 sm:pt-20 pb-24 sm:py-12 lg:ml-[212.333px] lg:mb-[1px] lg:pt-[7px]">
          <div className="relative flex flex-col items-center justify-center min-h-[300px] sm:min-h-[450px]">
            ...
            <motion.div 
              ...
              className="absolute top-[40%] xs:top-[42%] sm:top-[20%] md:top-[18%] w-full flex flex-row justify-between items-start z-0 px-[12%] xs:px-[15%] sm:px-[15%] md:px-[20%] lg:px-[24%] xl:px-[26%]"
            >
              ...
              <h2 className="font-serif italic font-normal text-4xl sm:text-6xl md:text-[90px] lg:text-[130px] text-charcoal/90 leading-none tracking-tight select-none pb-[10px] -translate-x-[15px] xs:-translate-x-[20px] sm:translate-x-0">
                there
              </h2>
            </motion.div>
